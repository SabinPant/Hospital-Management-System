    ...
    <section class="hero">
        <div class="container hero-grid">
            <div class="hero-content">
                ...
                <h1>A Brighter <br><span class="highlight">Healthcare</span> Experience</h1>
            ...
            <div class="hero-image">
                <img src="Public/Hospital/MediLife.png" alt="Medical Team" onerror="this.src='https://placehold.co/800x600/e2e8f0/2563eb?text=MediLife+Hospital'">
            </div>
        </div>
    </section>
        ...
        function checkLoginAndRedirect(event) {
            ...
            if (isLoggedIn) {
                ...
                Swal.fire({
                    ...
                    icon: 'info',
                    confirmButtonColor: '#2563eb', // Updated to match new theme
                    confirmButtonText: 'Go to Login',
                    showCancelButton: true,
                    cancelButtonText: 'Register',
                    cancelButtonColor: '#0ea5e9' // Updated to match new theme
                }).then((result) => {

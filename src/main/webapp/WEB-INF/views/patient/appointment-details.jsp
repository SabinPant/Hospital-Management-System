<%--
    Appointment Details Page — Hospital Management System 

    Displays detailed information about a single appointment,
    including doctor info, date/time, status, diagnosis,
    prescription, and cancellation details where applicable.
--%>
...
<head>
    ...
    <style>
        ...
        /* Cancel is only shown for pending appointments (see JSTL below) */
        .btn-cancel {
            background: white;
            color: #dc2626;
    ...
    <div class="details-container">
        <div class="details-card">
            ...
            <div class="details-body">
                ...
                <%-- Status badge class is derived dynamically from appointment.status value --%>
                <div class="detail-row">
                ...
                <%-- Post-consultation fields: only rendered when the doctor has filled them in --%>
                ...
                <%-- Cancellation reason is only meaningful when status is 'cancelled' --%>
                ...
                <div class="action-buttons">
                    ...
                    <%-- Cancel action is restricted to pending appointments only --%>
        ...
        function cancelAppointment(id) {
            ...
            if (reason !== null && reason.trim() !== '') {
                window.location.href =
                    '${pageContext.request.contextPath}/patient/cancel-appointment'
                    + '?id=' + id

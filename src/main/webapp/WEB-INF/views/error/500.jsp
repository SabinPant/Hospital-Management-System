...
<head>
    ...
    <title>Server Error | MediLife</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .err-icon { font-size: 3rem; color: #fca5a5; margin-bottom: 20px; }
